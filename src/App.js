...
function Audio_Player_Source(props){
  ...
  const audio_player_source_style = {top: (680 * props.current_height / original_page_height) + 'px', 
...
function Audio_Player_Generated_Pad1(props){
  const audio_player_generated1_style = {top: (680 * props.current_height / original_page_height) + 'px', 
